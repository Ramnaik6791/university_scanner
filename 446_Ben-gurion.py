...
def bengurion():
    url = "https://in.bgu.ac.il/en/natural_science/cs/Pages/People/CSStaffDBSeniorFaculty.aspx"   # homepage url
    ...
    filename = "bengurion.txt"
    f = open(filename, "w")

    excel_filename = "bengurion.csv"
    ...
    d = soup.find('div',{'class':'ms-webpart-zone ms-fullWidth'})
    #print(d)
    dd = d.find_all('div', {'class': 'MemberBox'})
    print(dd)
    ...
    for i in d:
        ...
        #print(link)
        name = a.get('title')                 # extracting prof name
        # print(name, "\t", link)
        name = name.strip()
        #print(name)
