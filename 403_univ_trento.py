...
def trento():
    url = "https://webapps.unitn.it/du/en/StrutturaAccademica/STO0008629/Persone"   # homepage url
    ...
    #d = soup.find_all('div', class_= 'riquadro-persona')
    #print(d)

    #d = soup.find_all('h4', {'class': 'riquadro-persona'})
    d = soup.find_all('h4')
    print(d)
...
def filterandgetEmail(var, garbage_emails, name, link, email, prof_resp):
    ...
    keyword_list = ['Computer architecture','computer architecture','Computer Architecture', 'Hardware And System Architecture', 'hardware and system architecture', 
                'Hardware and Architecture', 'hardware and architecture', 'embedded system', 'Embedded System','Embedded Systems','Computer Organization','VLSI', 'Computer and System',
