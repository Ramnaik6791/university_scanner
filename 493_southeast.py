...
def southeast():
    url = "https://www.seu.edu.bd/dept/cse.php?id=faculty"   # homepage url
    ...
    d = soup.find_all('tr', {'class':'custom_font'})
    #print(d)
    # count = 0 
    ...
    for i in d:
        ...
        if a == None:
            continue
        link = "https://www.seu.edu.bd/"+a.get('href')                # extracting prof page link
        #print(link)
        name=i.find('strong')
