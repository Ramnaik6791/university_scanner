...
def amu_cairo():
    url = "https://sse.aucegypt.edu/people/faculty"   # homepage url
    ...
    filename = "amu_cairo.txt"
    f = open(filename, "w")

    excel_filename = "amu_cairo.csv"
    ...
    d = soup.find_all('div', {'class':'col-sm-6 col-md-3 profile-component field--item'})
    #print(d)
    ...
    for i in d:
        ...
        #print(link)
        name = i.find('div',{'class':'field field--name-field-title field--type-string field--label-hidden field--item'})               # extracting prof name
        name=name.get_text()
        #print(name)
