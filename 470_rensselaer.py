...
def rensselaer():
    url = "https://science.rpi.edu/computer-science/faculty"   # homepage url
    ...
    filename = "rensselaer.txt"
    f = open(filename, "w")

    excel_filename = "rensselaer.csv"
    ...
    d = soup.find_all('div', {'class':'facultyBoxInner'})
    #print(d)
    #dd = d.find_all('h2')
    #print(dd)
    ...
    for i in d:
        ...
        #print(a)
        link = "https://science.rpi.edu"+ a.get('href')                # extracting prof page link
        #print(link)
        name = a.h2.get_text()               # extracting prof name
        print(name)
