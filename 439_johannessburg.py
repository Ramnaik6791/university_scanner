...
def johannesburg():
    url = "https://www.uj.ac.za/faculties/science/departments-2/academy-of-computer-science-and-software-engineering/about-us/academic-staff/"   # homepage url
    ...
    filename = "johannesburg.txt"
    f = open(filename, "w")

    excel_filename = "johannesburg.csv"
