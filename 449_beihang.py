...
def beihang():
    url = "https://www.researchgate.net/institution/Beihang-University-BUAA/department/Department-of-Computer-Science-and-Technology/members/11" # homepage url
    ...
    filename = "beihang.txt"
    f = open(filename, "w")

    excel_filename = "beihang.csv"
