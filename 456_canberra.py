...
def canberra():
    url = "https://www.canberra.edu.au/about-uc/faculties/SciTech/our-people"   # homepage url
    ...
    filename = "canberra.txt"
    f = open(filename, "w")

    excel_filename = "canberra.csv"
    ...
    d = soup.find_all('div', {'id':'content_container_1508972_1510021'})
    dd = d.find('p')
    #print(d)
    #dd=d.find_all('td',{'class':'even'})
    #print(dd)
