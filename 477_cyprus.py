...
def ucy():
    url = "https://www.cs.ucy.ac.cy/index.php/people/faculty"   # homepage url
    ...
    d = soup.find_all('div', {'list-title span10 col-md-10'})
    #print(d)
    #dd = d.find_all('a')
    # count = 0 
    ...
    for i in d:
        ...
        if a == None:
            continue
        link = "https://www.cs.ucy.ac.cy" + a.get('href')  # extracting prof page link
        #print(link)
