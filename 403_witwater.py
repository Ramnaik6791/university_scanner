...
def witwater():
    url = "https://www.wits.ac.za/csam/staff/"   # homepage url
    ...
    filename = "witwater.txt"
    f = open(filename, "w")

    excel_filename = "witwater.csv"
    ...
    for i in dd:
        ...
        if a == None:
            continue
        link = "https://www.wits.ac.za" + a.get('href')  # extracting prof page link
