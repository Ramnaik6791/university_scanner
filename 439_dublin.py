...
def dublin():
    url = "https://www.dcu.ie/engineeringandcomputing/people-faculty-engineering-and-computing"   # homepage url
    ...
    for i in d:
        ...
        if a==None:
            continue
        link = "https://www.dcu.ie" + a.get('href')                # extracting prof page link
