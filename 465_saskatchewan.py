...
def saskatchewan():
	url = "https://www.cs.usask.ca/people/faculty.php"   # homepage url
	...
	filename = "saskatchewan.txt"
	f = open(filename, "w")

	excel_filename = "saskatchewan.csv"
	...
	d = soup.find_all('div',{'class':'col-xs-9 col-md-10'})
	#dd=d.find_all('h2')
	#print(dd)
	# count = 0 
	...
	for i in d:
		...
		if a == None:
			continue
		link = "https://www.cs.usask.ca/people/" + a.get('href')                # extracting prof page link
		#print(link)
