...
def Alcala():
    url = "https://www.uah.es/en/conoce-la-uah/campus-centros-y-departamentos/departamentos/Computer-Science/"   # homepage url
    ...
    for i in d:
        ...
        if a == None:
            continue
        link = "https://www.uah.es" + a.get('href')                # extracting prof page link
        #print(link)
