...
def oregon():
    url = "https://eecs.oregonstate.edu/people/faculty-directory"   # homepage url
    ...
    dd = d.find_all('td',{'class':'views-field views-field-field-title3'})
    #print(dd)
    # count = 0 
    ...
    for i in dd:
        ...
        link = "https://eecs.oregonstate.edu" +a.get('href')                # extracting prof page link
        #print(link)
