...
def colorado():
    url = "https://compsci.colostate.edu/people/"   # homepage url
    ...
    garbage_emails = ['compsci_receptionist@Mail.colostate.edu','compsci_info@colostate.edu']
    ...
    #print(d)
    dd = soup.find_all('div', {'class': 'mk-text-block'})
    #print(dd)
