...
def Concordia():
    url = "https://www.concordia.ca/ginacody/computer-science-software-eng/about/faculty-members.html"   # homepage url
    ...
    filename = "Concordia.txt"
    f = open(filename, "w")

    excel_filename = "Concordia.csv"
    ...
    garbage_emails = ['reception@cse.concordia.ca']

    var = [f, csvwriter, csvwriter2, u_name, country]

    # d gives the array of all profs on the dept homepage
    d = soup.find('div', {'class':'with_socialbar'})
    #print(d)
    heading_tags = ["h5"]
    dd = d.find_all(heading_tags)
    #print(dd)
    ...
    for i in dd:
        ...
        link = "https://www.concordia.ca"+a.get('href')                # extracting prof page link
        #print(link)
