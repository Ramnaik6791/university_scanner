...
def Essex():
	url = "https://www.essex.ac.uk/departments/computer-science-and-electronic-engineering/people/academic"   # homepage url
	...
	u_name = "Essex"
	country = "UK"
	garbage_emails = ['admit@essex.ac.uk','enquiries@essex.ac.uk','pgadmit@essex.ac.uk']
	...
	for i in d:
		if i.get('href')==None:
			continue
		link = "https://www.essex.ac.uk" + i.get('href')  # extracting prof page link
		print(link)
