...
def Missouri():
    url = "https://engineering.missouri.edu/academics/eecs/eecs-faculty/"   # homepage url
    ...
    filename = "Missouri.txt"
    f = open(filename, "w")

    excel_filename = "Missouri.csv"
    ...
    garbage_emails = ['info@gmail.com','engineering@missouri.edu']

    var = [f, csvwriter, csvwriter2, u_name, country]

    # d gives the array of all profs on the dept homepage
    d = soup.find('div', {'class':'entry-content clearfix'})
    #print(d)
    heading_tags = ["h3", "h4"]
