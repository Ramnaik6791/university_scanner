...
def sogang():
    url = "https://ecs.sogang.ac.kr/ecs/ecs02_1.html"   # homepage url
    ...
    for i in dd:
        ...
        if a == None:
            continue
        link = "https://ecs.sogang.ac.kr" + a.get('href')                # extracting prof page link
        #print(link)
        name=i.find('span',{'style':'font-size: 16pt;'})
