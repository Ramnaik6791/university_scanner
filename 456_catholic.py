...
def catholic():
    url = "https://csie.catholic.ac.kr/front/profintrolist.do?cmsDirPkid=4039&cmsLocalPkid=0&rSiteGubun=106&searchSustCd=M230000359&searchPosiFg=10&searchChk=Y"   # homepage url
    ...
    filename = "catholic.txt"
    f = open(filename, "w")

    excel_filename = "catholic.csv"
    ...
    d = soup.find('div',{'class':'professor_list'})
    dd = d.find_all('div', {'class':'item'})
    #print(dd)
    # count = 0 
