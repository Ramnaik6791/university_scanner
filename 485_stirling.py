...
def stirling():
    url = "https://www.stir.ac.uk/about/faculties/natural-sciences/departments/natural-sciences-staff-directory/computing-science-and-mathematics-staff/"   # homepage url
    ...
    filename = "stirling.txt"
    f = open(filename, "w")

    excel_filename = "stirling.csv"
