...
def uc_riverside():
    url = "https://cen.ucr.edu/about/faculty-and-staff"   # homepage url
    ...
    filename = "uc_riverside.txt"
    f = open(filename, "w")

    excel_filename = "uc_riverside.csv"
    ...
    d = soup.find_all('li', {'class':'column ng-star-inserted'})
    #print(d)
