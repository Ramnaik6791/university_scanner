...
def hasselt():
    url = "https://www.researchgate.net/institution/Hasselt-University/department/Department-Computer-Sciences/members"   # homepage url
    ...
    filename = "hasselt.txt"
    f = open(filename, "w")

    excel_filename = "hasselt.csv"
