...
def brandeis():
    url = "https://www.brandeis.edu/computer-science/people/index.html"   # homepage url
    ...
    filename = "brandeis.txt"
    f = open(filename, "w")

    excel_filename = "brandeis.csv"
    ...
    d = soup.find_all('div', {'class':'faculty__listing'})
    #print(d)
