...
def Aberystwyth():
    url = "https://www.aber.ac.uk/en/cs/staff-profiles/listing/az/"   # homepage url
    ...
    filename = "Aberystwyth.txt"
    f = open(filename, "w")

    excel_filename = "Aberystwyth.csv"
    ...
    for i in d:
        ...
        if a == None:
            continue
        link = "https://www.aber.ac.uk/en/cs/staff-profiles/listing"+ a.get('href')                # extracting prof page link
        #print(link)
