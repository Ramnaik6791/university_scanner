...
def amirkabir():
    url = "https://math.aut.ac.ir/content/10497/Faculty-Members-of-Computer-Sciences"  # homepage url
    ...
    filename = "amirkabir.txt"
    f = open(filename, "w")

    excel_filename = "amirkabir.csv"
    ...
    garbage_emails = ['info@aut.ac','intrel@aut.ac.ir']
