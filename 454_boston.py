...
def boston():
    url = "https://www.bc.edu/bc-web/schools/mcas/departments/computer-science/people.html#tab-core_faculty"   # homepage url
    ...
    for i in d:
        ...
        if a==None:
            continue
        link = "https://www.bc.edu/" +a.get('href')                # extracting prof page link
        print(link)
