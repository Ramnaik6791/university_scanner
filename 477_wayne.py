...
def wayne():
    url = "https://engineering.wayne.edu/computer-science/faculty"   # homepage url
    ...
    d = soup.find_all('li', {'class':'w-full sm:w-1/2 md:w-1/3 px-4 pb-6'})
    #print(d)
    ...
    for i in d:
        ...
        #print(a)
        link = "https://engineering.wayne.edu"+ a.get('href')                # extracting prof page link
        #print(link)
