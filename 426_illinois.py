...
def illinois():
    url = "https://www.iit.edu/directory/people?organization=2296"   # homepage url
    ...
    filename = "illinois.txt"
    f = open(filename, "w")

    excel_filename = "illinois.csv"
    ...
    d = soup.find_all('div', {'class': 'profile-item__meta profile-item__column'})
    #print(d)
    #dd=d.find_all('p')
    #print(dd)
    # count = 0 
    ...
    for i in d:
        ...
        if a == None:
            continue
        link = "https://www.iit.edu" + a.get('href')                # extracting prof page link
        print(link)
